...
class Fighter extends Sprite {
    ...
    update() {
        ...
        if(this.facingSide === 'normal') {
            this.attackBox.position.x = this.position.x + this.attackBox.offset.xNormal;
        } else if(this.facingSide === 'opposite') {
            this.attackBox.position.x = this.position.x + this.attackBox.offset.xOpposite;
        }

        // draw visible attack box
        // c.fillStyle = 'black';
    ...
    switchSprite(sprite) {
        ...
        if(
            ...
            (this.image === this.sprites.attack2.image && this.frameCurrent < this.sprites.attack2.framesMax - 1)
        ) return;
        ...
        if(
            ...
            (this.image == this.sprites.takeHit2.image && this.frameCurrent < this.sprites.takeHit2.framesMax - 1)
        ) return;
